...
\r (возврат каретки) — возврат к началу буфера
\t (табуляция) — переход к следующей позиции табуляции
## **Демонстрация работы цветовых макросов**
![Описание изображения](media/Demonstration_color_macros.png)
## Код вызова макросов
```rust
println_error!("\nRunix Error: {}", 0);
println_warn!("\n\tRunix Warn: {}", 1);
...
<video width="640" height="360" controls>
  <source src="media/scroll_up.mp4" type="video/mp4">
...
<video width="640" height="360" controls>
  <source src="media/clear_buffer.mp4" type="video/mp4">
  Ваш браузер не поддерживает видео.
</video>
## **Метод `first_line()`**
...
<video width="640" height="360" controls>
  <source src="media/first_line.mp4" type="video/mp4">
  Ваш браузер не поддерживает видео.
</video>
